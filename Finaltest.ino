...
const char ssid[]     = "LQ";         // 使用时请修改为当前你的 wifi 名称 -- Please use your own wifi ssid
...
const char APIKEY[] = "477dc4e473686938c1df96c5c706fbd6";    // 使用时请修改为你的API KEY -- Please use your own API KEY
int32_t DeviceId = HUAWEI MATE 30;                             // 使用时请修改为你的设备ID -- Please use your own device ID
